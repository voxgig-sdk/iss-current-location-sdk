...
(0, node_test_1.describe)('IssLocationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.IssCurrentLocationSDK({
    ...
    (0, node_test_1.test)('direct-load-iss_location', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-iss_location', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.ISS_CURRENT_LOCATION_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.IssCurrentLocationSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['ISS_CURRENT_LOCATION_TEST_ISS_LOCATION_ENTID'];
    ...
    const client = new __1.IssCurrentLocationSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=IssLocationDirect.test.js.map