...
class IssCurrentLocationTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IssCurrentLocationTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = IssCurrentLocationTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = IssCurrentLocationTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
