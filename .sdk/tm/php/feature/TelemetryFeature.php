...
// IssCurrentLocation SDK telemetry feature
...
class IssCurrentLocationTelemetryFeature extends IssCurrentLocationBaseFeature
{
    ...
    private function _close(IssCurrentLocationContext $ctx, bool $ok): void
    {
