...
// IssCurrentLocation SDK idempotency feature
...
class IssCurrentLocationIdempotencyFeature extends IssCurrentLocationBaseFeature
{
    ...
    private function _mutating(IssCurrentLocationContext $ctx): bool
    {
