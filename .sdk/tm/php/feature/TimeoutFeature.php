...
// IssCurrentLocation SDK timeout feature
...
class IssCurrentLocationTimeoutFeature extends IssCurrentLocationBaseFeature
{
    ...
    private function _with_timeout(IssCurrentLocationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(IssCurrentLocationContext $_ctx, float $ms): void
    {
        $client = $this->client;
