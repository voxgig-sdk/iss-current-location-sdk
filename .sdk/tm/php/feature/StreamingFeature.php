...
// IssCurrentLocation SDK streaming feature
...
class IssCurrentLocationStreamingFeature extends IssCurrentLocationBaseFeature
{
    ...
    private function _iterate(IssCurrentLocationResult $result): \Generator
    {
    ...
    private function _streamable(IssCurrentLocationContext $ctx): bool
    {
