...
// IssCurrentLocation SDK audit feature
...
class IssCurrentLocationAuditFeature extends IssCurrentLocationBaseFeature
{
    ...
    private function _emit(IssCurrentLocationContext $ctx, string $outcome): void
    {
