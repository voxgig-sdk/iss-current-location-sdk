...
// IssCurrentLocation SDK utility type

class IssCurrentLocationUtility
{
    ...
    public static function copy(IssCurrentLocationUtility $src): IssCurrentLocationUtility
    {
        $u = new IssCurrentLocationUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
