...
// IssCurrentLocation SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class IssCurrentLocationMakeRequest
{
    public static function call(IssCurrentLocationContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new IssCurrentLocationResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new IssCurrentLocationResponse($fetched);
        } else {
