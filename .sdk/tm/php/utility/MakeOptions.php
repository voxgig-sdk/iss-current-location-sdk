...
// IssCurrentLocation SDK utility: make_options

class IssCurrentLocationMakeOptions
{
    ...
    public static function call(IssCurrentLocationContext $ctx): array
    {
        ...
        //
        // `IssCurrentLocationSchema::optspec()` is built from the model:
        ...
        $optspec = IssCurrentLocationSchema::optspec();
