...
|---|---|---|
| `ts/` | @voxgig-sdk/iss-current-location-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/iss-current-location-sdk \
      --repository voxgig-sdk/iss-current-location-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/iss-current-location-sdk` shows it, and
`npm trust revoke @voxgig-sdk/iss-current-location-sdk --id=<id>` removes it.
