...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/iss-current-location` | `npm install @voxgig-sdk/iss-current-location` |
| Python | `voxgig-sdk-iss-current-location` | `pip install voxgig-sdk-iss-current-location` |
| PHP | `voxgig-sdk/iss-current-location` | `composer require voxgig-sdk/iss-current-location` |
| Golang | `github.com/voxgig-sdk/iss-current-location-sdk/go` | `go get github.com/voxgig-sdk/iss-current-location-sdk/go` |
| Ruby | `voxgig-sdk-iss-current-location` | `gem install voxgig-sdk-iss-current-location` |
| Lua | `voxgig-sdk-iss-current-location` | `luarocks install voxgig-sdk-iss-current-location` |
