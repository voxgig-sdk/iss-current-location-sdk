...
Results: Successful response with current ISS location.
...
| --- | --- | --- | --- |
| IssLocation | `load` | `GET /iss-now.json` | See reference |

## Connect to the API

- Open Notify API Server: `http://api.open-notify.org`
...
- `iss-current-location_list`: List records for an entity. No active entity supports this operation.
- `iss-current-location_load`: Load one record for an entity. Supported entities: `iss_location`.
