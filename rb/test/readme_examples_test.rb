...
#      offline in seeded test mode (IssCurrentLocationSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "IssCurrentLocation_sdk.rb")
  SDK_CLASS = "IssCurrentLocationSDK"
  ...
  SDK_BASE = "IssCurrentLocation_sdk"
