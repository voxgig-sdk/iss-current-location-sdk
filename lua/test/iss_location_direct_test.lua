...
describe("IssLocationDirect", function()
  it("should direct-load-iss_location", function()
    local setup = iss_location_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-iss_location", setup.live and "live" or "unit")
