...
function runner.env_override(m)
  local live = runner.getenv("ISSCURRENTLOCATION_TEST_LIVE")
  local override = runner.getenv("ISSCURRENTLOCATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("ISSCURRENTLOCATION_TEST_EXPLAIN")
