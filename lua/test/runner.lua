...
function runner.env_override(m)
  local live = runner.getenv("ISS_CURRENT_LOCATION_TEST_LIVE")
  local override = runner.getenv("ISS_CURRENT_LOCATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("ISS_CURRENT_LOCATION_TEST_EXPLAIN")
