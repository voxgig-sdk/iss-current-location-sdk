...
local IssLocationEntity = {}
IssLocationEntity.__index = IssLocationEntity


function IssLocationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, IssLocationEntity)
  self._name = "iss_location"
  self._client = client
...
function IssLocationEntity:get_name()
  return self._name
end


function IssLocationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return IssLocationEntity.new(self._client, opts)
end
...
function IssLocationEntity:mark_deleted()
  self._deleted = true
end


function IssLocationEntity:deleted()
  return true == self._deleted
end


function IssLocationEntity:data_set(args)
  if args ~= nil then
...
function IssLocationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function IssLocationEntity:match_set(args)
  if args ~= nil then
...
function IssLocationEntity:match_get()
...
function IssLocationEntity:stream(action, args, callopts)
...
function IssLocationEntity:_run_op(ctx, post_done)
  local utility = self._utility
