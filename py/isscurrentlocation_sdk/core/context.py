...
from isscurrentlocation_sdk.core.helpers import get_ctx_prop, to_map
...
class IssCurrentLocationContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = IssCurrentLocationControl()
        ...
        if isinstance(sp, IssCurrentLocationSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, IssCurrentLocationResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, IssCurrentLocationResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return IssCurrentLocationOperation({})
    ...
    def make_error(self, code, msg):
        return IssCurrentLocationError(code, msg, self)
