...
from isscurrentlocation_sdk.utility import register

# Load features
from isscurrentlocation_sdk.feature.base_feature import IssCurrentLocationBaseFeature
from isscurrentlocation_sdk.features import _has_feature, _make_feature
...
class IssCurrentLocationSDK:
    ...
    def get_utility(self):
        return IssCurrentLocationUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("IssCurrentLocationSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def IssLocation(self, data=None) -> "IssLocationEntity":
        ...
        from isscurrentlocation_sdk.entity.iss_location_entity import IssLocationEntity
