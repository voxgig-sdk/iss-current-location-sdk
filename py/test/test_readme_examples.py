# IssCurrentLocation SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions IssCurrentLocationSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both IssCurrentLocationSDK(...) and IssCurrentLocationSDK.test(...) become
#      IssCurrentLocationSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "isscurrentlocation_sdk"
_SDK_CLASS = "IssCurrentLocationSDK"
