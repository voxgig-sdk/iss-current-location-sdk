...
type Args struct {
	Entity string         `json:"entity" jsonschema:"iss_location"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.IssCurrentLocationSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "iss-current-location_list",
		Description: "List records from IssCurrentLocation. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "iss-current-location_load",
		Description: "Load a single record from IssCurrentLocation. " +
...
func runOp(client *sdk.IssCurrentLocationSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.IssCurrentLocationSDK, name string) (sdk.IssCurrentLocationEntity, error) {
	switch strings.ToLower(name) {
	case "iss_location":
		return client.IssLocation(nil), nil
