// Command IssCurrentLocation-mcp is an MCP server exposing the IssCurrentLocation
// SDK as MCP tools.
//
// Two tools are registered:
//
//	IssCurrentLocation_list  — list records of an entity
//	IssCurrentLocation_load  — load a single record of an entity
//
