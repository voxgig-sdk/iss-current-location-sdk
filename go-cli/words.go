...
func registerSDKWords(r *eng.Registry, client *sdk.IssCurrentLocationSDK) {
...
func runOp(client *sdk.IssCurrentLocationSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
