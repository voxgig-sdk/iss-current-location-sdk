// Command IssCurrentLocation-cli is a CLI + REPL for the IssCurrentLocation SDK,
...
const prompt = "iss-current-location"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "iss_location"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      ISS_CURRENT_LOCATION_APIKEY (api key), ISS_CURRENT_LOCATION_BASE (base url override)")
