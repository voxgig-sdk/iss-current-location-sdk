...
type IssCurrentLocationSDK struct {
	Mode     string
...
func (sdk *IssCurrentLocationSDK) OptionsMap() map[string]any {
...
func (sdk *IssCurrentLocationSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *IssCurrentLocationSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *IssCurrentLocationSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IssCurrentLocationSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *IssCurrentLocationSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *IssCurrentLocationSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("IssCurrentLocationSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *IssCurrentLocationSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IssCurrentLocationSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("IssCurrentLocationSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *IssCurrentLocationSDK {
	...
	sdk := NewIssCurrentLocationSDK(sdkopts)
	sdk.Mode = "test"
