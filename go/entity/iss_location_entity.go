...
type IssLocationEntity struct {
	name    string
	client  *core.IssCurrentLocationSDK
...
func NewIssLocationEntity(client *core.IssCurrentLocationSDK, entopts map[string]any) *IssLocationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IssLocationEntity) GetName() string { return e.name }
...
func (e *IssLocationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IssLocationEntity) Deleted() bool {
	return e.deleted
}


func (e *IssLocationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIssLocationEntity(e.client, opts)
}

func (e *IssLocationEntity) Data(args ...any) any {
...
func (e *IssLocationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an IssLocation; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IssLocationEntity) DataTyped(data ...IssLocation) IssLocation {
	if len(data) > 0 {
		return typedFrom[IssLocation](e.Data(asMap(data[0])))
	}
	return typedFrom[IssLocation](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through IssLocation (all fields
// optional at the wire level).
func (e *IssLocationEntity) MatchTyped(match ...IssLocation) IssLocation {
	if len(match) > 0 {
		return typedFrom[IssLocation](e.Match(asMap(match[0])))
	}
	return typedFrom[IssLocation](e.Match())
}
...
func (e *IssLocationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IssLocationEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IssLocationLoadMatch and returns an IssLocation. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *IssLocationEntity) LoadTyped(reqmatch IssLocationLoadMatch, ctrl map[string]any) (IssLocation, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return IssLocation{}, err
	}
	return typedFrom[IssLocation](res), nil
}



func (e *IssLocationEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *IssLocationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *IssLocationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *IssLocationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IssLocationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
