...
// IssCurrentLocation SDK utility: fetcher

class IssCurrentLocationFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; IssCurrentLocationSDK/1.0)';
    ...
    public static function call(IssCurrentLocationContext $ctx, string $fullurl, array $fetchdef): array
    {
