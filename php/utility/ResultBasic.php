...
// IssCurrentLocation SDK utility: result_basic

class IssCurrentLocationResultBasic
{
    public static function call(IssCurrentLocationContext $ctx): ?IssCurrentLocationResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof IssCurrentLocationError) ? $result->err->msg : (string)$result->err;
