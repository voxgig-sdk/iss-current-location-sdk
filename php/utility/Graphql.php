...
// IssCurrentLocation SDK utility: graphql
//
...
class IssCurrentLocationGraphql
{
    ...
    // equivalent.
    public static function body(IssCurrentLocationContext $ctx): mixed
    {
    ...
    public static function errors(IssCurrentLocationContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
