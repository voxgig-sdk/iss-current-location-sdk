...
// IssCurrentLocation SDK metrics feature
...
class IssCurrentLocationMetricsFeature extends IssCurrentLocationBaseFeature
{
    ...
    private function _record(IssCurrentLocationContext $ctx, bool $ok): void
    {
