...
// IssCurrentLocation SDK proxy feature
...
class IssCurrentLocationProxyFeature extends IssCurrentLocationBaseFeature
{
    ...
    public function init(IssCurrentLocationContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (IssCurrentLocationContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
