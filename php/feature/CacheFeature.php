...
// IssCurrentLocation SDK cache feature
...
class IssCurrentLocationCacheFeature extends IssCurrentLocationBaseFeature
{
    ...
    private function _through(IssCurrentLocationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
