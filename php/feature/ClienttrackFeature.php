...
// IssCurrentLocation SDK clienttrack feature
...
class IssCurrentLocationClienttrackFeature extends IssCurrentLocationBaseFeature
{
    ...
    public function PostConstruct(IssCurrentLocationContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'IssCurrentLocation-SDK';
