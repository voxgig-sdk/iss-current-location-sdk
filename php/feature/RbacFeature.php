...
// IssCurrentLocation SDK rbac feature
...
class IssCurrentLocationRbacFeature extends IssCurrentLocationBaseFeature
{
    ...
    private function _required(IssCurrentLocationContext $ctx): ?string
    {
    ...
    private function _reject(IssCurrentLocationContext $ctx, string $required): void
    {
    ...
    private function _track(IssCurrentLocationContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
