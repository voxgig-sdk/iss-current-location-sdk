...
// IssCurrentLocation SDK netsim feature
...
class IssCurrentLocationNetsimFeature extends IssCurrentLocationBaseFeature
{
    ...
    private function _simulate(IssCurrentLocationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(IssCurrentLocationContext $ctx, array $applied): void
    {
        $client = $this->client;
