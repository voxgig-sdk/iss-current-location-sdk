...
// IssCurrentLocation SDK ratelimit feature
...
class IssCurrentLocationRatelimitFeature extends IssCurrentLocationBaseFeature
{
    ...
    private function _acquire(IssCurrentLocationContext $ctx): void
    {
    ...
    private function _track(IssCurrentLocationContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
