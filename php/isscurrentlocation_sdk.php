...
class IssCurrentLocationSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = IssCurrentLocationHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = IssCurrentLocationHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!IssCurrentLocationFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, IssCurrentLocationFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return IssCurrentLocationUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = IssCurrentLocationHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = IssCurrentLocationHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = IssCurrentLocationHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new IssCurrentLocationError($op . "_allow",
                "IssCurrentLocationSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = IssCurrentLocationHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new IssCurrentLocationError("graphql_error",
                "IssCurrentLocationSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function IssLocation($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_iss_location === null) {
                $this->_iss_location = new IssLocationEntity($this, null);
            }
            return $this->_iss_location;
        }
        return new IssLocationEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new IssCurrentLocationSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
