# IssCurrentLocation PHP SDK Reference

Complete API reference for the IssCurrentLocation PHP SDK.
...
#### `IssCurrentLocationSDK::test($testopts = null, $sdkopts = null)`
