...
// IssCurrentLocation SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (IssCurrentLocationSDK::test)
...
{
    private const SDK_CLASS = 'IssCurrentLocationSDK';
    ...
    private const SDK_BASE = 'isscurrentlocation_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../isscurrentlocation_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
