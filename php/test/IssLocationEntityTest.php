...
class IssLocationEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set ISS_CURRENT_LOCATION_TEST_ISS_LOCATION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function iss_location_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("ISS_CURRENT_LOCATION_TEST_ISS_LOCATION_ENTID");
